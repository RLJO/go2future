...
class ProductTemplate(models.Model):
    ...
    def _get_default_category_id(self):
        if self.marketplace_seller_id:
            mp_categ = self.marketplace_seller_id.internal_categ
            if mp_categ:
                return mp_categ.id
    ...
    def onchange_seller_id(self):
        ...
        if self.marketplace_seller_id and self.marketplace_seller_id.internal_categ:
            self.categ_id = self.marketplace_seller_id.internal_categ.id
    ...
    def create(self, vals):
        ...
        if partner and partner.sudo().seller:
            ...
            if partner.internal_categ:
                vals["categ_id"] = partner.internal_categ.id
