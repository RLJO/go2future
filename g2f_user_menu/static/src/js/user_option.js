...
var UserMenu = Widget.extend({
    ...
    _onMenuDocumentation: function () {
        window.open('https://www.minigo.store/slides', '_blank');
//        var self = this;
//        var session = this.getSession();
//        this.trigger_up('clear_uncommitted_changes', {
//            callback: function () {
...
//                        method: "search_branding_documentation"
//                    })
...
//        });
    ...
    _onMenuSupport: function () {
        window.open('https://www.minigo.store/helpdesk/', '_blank');
//        var self = this;
//        var session = this.getSession();
//        this.trigger_up('clear_uncommitted_changes', {
//            callback: function () {
//                self._rpc({
//                        model: "res.config.settings",
//                        method: "search_branding_support"
//                    })
//                    .then(function (result) {
//                        window.open( result, '_blank');
//                    });
